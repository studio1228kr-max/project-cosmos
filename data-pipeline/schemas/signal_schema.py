...
SIGNAL_TYPES = {
    ...
    'DART_AMENDMENT':            'INFO',
    # #4 신규 — 부실/디폴트/유동성/지배구조
    'DART_DEFAULT_EVENT':        'FATAL',
    'DART_COURT_REHABILITATION': 'CRITICAL',
    'DART_COURT_BANKRUPTCY':     'FATAL',
    'DART_FRAUD_EMBEZZLEMENT':   'CRITICAL',
    'DART_DEBT_GUARANTEE':       'REVIEW',
    'DART_LIQUIDITY_BORROWING':  'REVIEW',
    'DART_OWNERSHIP_CHANGE':     'REVIEW',
    'DART_SERIOUS_ACCIDENT':     'REVIEW',
    'DART_LAWSUIT_FILED':        'WATCH',
    'DART_EQUITY_RAISE':         'WATCH',
    'DART_LARGE_CONTRACT':       'WATCH',
    'DART_EQUITY_ACQUISITION':   'INFO',
    # 법원 (Phase 2)
